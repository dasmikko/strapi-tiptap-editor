              ...
              <DialogBody icon={<Link />}>
                <Stack size={2}>
                  <Flex justifyContent="center">
                    <TextInput placeholder="Write or paste the url here" name="url" onChange={e => setLinkInput(e.target.value)} value={linkInput} aria-label="URL"/>
                  </Flex>
                </Stack>
              </DialogBody>
              <DialogFooter startAction={<Button onClick={() =>  {setLinkInput(''); setIsVisibleLinkDialog(false)}} variant="tertiary">
                Cancel
